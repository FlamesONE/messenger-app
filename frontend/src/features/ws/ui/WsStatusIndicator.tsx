...
import { useWsStatus, type WsStatus } from "../model/ws-status";
...
export const WsStatusIndicator = memo(function WsStatusIndicator() {
	...
	return (
		<div className="fixed bottom-4 left-4 z-50 flex items-center gap-2 rounded-lg bg-surface-elevated px-3 py-2 text-xs text-surface-muted ring-1 ring-surface-border animate-in slide-in-from-bottom-2 fade-in">
